# Generated by Django 4.2.6 on 2023-10-22 17:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='Должно содержать 13 симболоа', max_length=13, verbose_name='ISBN книги')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('inv_nom', models.CharField(help_text='Введите инвентарный номер экземпляра книги', max_length=20, verbose_name='Инвентарный номер экземпляра книги')),
                ('imprint', models.CharField(help_text='Введите издательство экземпляра книги', max_length=200, verbose_name='Издательство экземпляра книги')),
                ('due_back', models.DateField(blank=True, help_text='Введите конец статуса', null=True, verbose_name='Дата окончания статуса')),
